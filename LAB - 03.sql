...
SELECT SNAME FROM STUDENT WHERE CITY='SURAT' OR CITY='RAJKOT'


--9.Display names of students with branch whose SPI is greater than 8.0 and ID is less than 105.--

SELECT SNAME,BRANCH FROM STUDENT WHERE SPI>8.0 AND STDID>105

--10. Find all students 
-- whose SPI is greater than or equal to7.0 and less than or equal to 9.0 (USE AND & BETWEEN). --

SELECT SNAME FROM STUDENT WHERE SPI>=7.0 AND SPI<=9.0
...
SELECT * FROM STUDENT WHERE BRANCH !='COMPUTER'
SELECT * FROM STUDENT WHERE NOT BRANCH='COMPUTER'

--12. Display Student ID, Name & SPI of students 
--who belong to ‘COMPUTER’, ‘CIVIL’ or ‘CHEMICAL’ branch 
...
--13. 13. Display all student IDs and names who do not belong to ‘COMPUTER’ or ‘CIVIL’ branch (USE NOT IN)

SELECT SNAME,STDID FROM STUDENT WHERE BRANCH NOT IN ('COMPUTER','CIVIL')
...
SELECT TOP 50 PERCENT STDID FROM STUDENT 
...
--23. Select all records from STUDENT where SPI is greater than 7.0 and less than or equal to 9.0, 
--and student ID is between 102 and 108. 
...
SELECT * FROM STUDENT 
WHERE SPI > 7.50 AND STDID BETWEEN 100 AND 110 AND CITY = 'RAJKOT' OR CITY = 'SURAT'

--28. Display details of students who belong to ‘CIVIL’ or ‘MECHANICAL’ branch and SPI is greater than 8.0.

SELECT * FROM STUDENT 
WHERE BRANCH = 'CIVIL' OR  BRANCH = 'MECHANICAL' AND SPI >8.00
